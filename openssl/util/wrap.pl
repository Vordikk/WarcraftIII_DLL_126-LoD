...
BEGIN {
    ...
    require 'c:/Projects/WAR3/WarcraftIII_DLL_126-xxx/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'c:/Projects/WAR3/WarcraftIII_DLL_126-xxx/openssl/test/fips-and-base.cnf';
    shift;
